...
3. 201001043_classify.cpp contains the code to read a test case file (with space separated values. See file 'image_vector' for exact format) and output the result using the pre-computed classifier vectors.
...
<algorithm number> are: 1. Single Sample perceptron
												2. Batch Perceptron
												4. Single Sample Perceptron With Margin
